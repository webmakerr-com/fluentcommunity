...
class BelongsToMany extends Relation
{
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Eloquent\Builder<TRelatedModel>  $query
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Eloquent\Builder<TRelatedModel>|null  $query
     * @return $this
     */
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Eloquent\Collection<int, TRelatedModel>  $results
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\FluentCommunity\Framework\Support\ArrayableInterface<array-key, mixed>|array<mixed>) ? \FluentCommunity\Framework\Database\Eloquent\Collection<int, TRelatedModel> : TRelatedModel)
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\FluentCommunity\Framework\Support\ArrayableInterface<array-key, mixed>|array<mixed>) ? \FluentCommunity\Framework\Database\Eloquent\Collection<int, TRelatedModel> : TRelatedModel|null)
     */
     ...
     * @param  array  $columns
     * @return \FluentCommunity\Framework\Database\Eloquent\Collection<int, TRelatedModel>
     */
     ...
     * @return ($id is (\FluentCommunity\Framework\Support\ArrayableInterface<array-key, mixed>|array<mixed>) ? \FluentCommunity\Framework\Database\Eloquent\Collection<int, TRelatedModel> : TRelatedModel)
     *
     * @throws \FluentCommunity\Framework\Database\Eloquent\ModelNotFoundException<TRelatedModel>
     */
     ...
     * @return (
     *     $id is (\FluentCommunity\Framework\Support\ArrayableInterface<array-key, mixed>|array<mixed>)
     *     ? \FluentCommunity\Framework\Database\Eloquent\Collection<int, TRelatedModel>|TValue
     ...
     *
     * @return \FluentCommunity\Framework\Database\Eloquent\Builder<TRelatedModel>
     */
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Eloquent\Builder<TRelatedModel>  $query
     * @param  \FluentCommunity\Framework\Database\Eloquent\Builder<TDeclaringModel>  $parentQuery
