 ...
 * @template TResult
 *
 * @extends \FluentCommunity\Framework\Database\Orm\Relations\Relation<TRelatedModel, TIntermediateModel, TResult>
 */
abstract class HasOneOrManyThrough extends Relation
{
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\FluentCommunity\Framework\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \FluentCommunity\Framework\Database\Orm\Collection<int, TRelatedModel> : TRelatedModel|null)
     */
     ...
     *
     * @param  \FluentCommunity\Framework\Contracts\Support\ArrayableInterface|array  $ids
     * @param  array  $columns
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\FluentCommunity\Framework\Contracts\Support\ArrayableInterface<array-key, mixed>|array<mixed>) ? \FluentCommunity\Framework\Database\Orm\Collection<int, TRelatedModel> : TRelatedModel)
     *
     * @throws \FluentCommunity\Framework\Database\Orm\ModelNotFoundException<TRelatedModel>
     */
     ...
     * @param  (\Closure(): TValue)|null  $callback
     * @return (
     *     $id is (\FluentCommunity\Framework\Contracts\Support\ArrayableInterface<array-key, mixed>|array<mixed>)
     *     ? \FluentCommunity\Framework\Database\Orm\Collection<int, TRelatedModel>|TValue
     ...
     * @param  int  $page
     * @return \FluentCommunity\Framework\Contracts\Pagination\LengthAwarePaginator
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \FluentCommunity\Framework\Contracts\Pagination\Paginator
     */
     ...
     * @return \FluentCommunity\Framework\Contracts\Pagination\CursorPaginator
     */
